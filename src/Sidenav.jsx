  ...
  {(popupState) => (
    <React.Fragment>
        ...
        <MenuItem onClick={popupState.close}>Logout</MenuItem>
            ...
            <ListItem  disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/create workspace")}}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
              ...
              >
                ...
                <ListItemText primary="Create Workspace" sx={{ opacity: open ? 1 : 0 }} />
              </ListItemButton>
            </ListItem>
        </List>
      </Drawer>
